...
import CalculoActual from "./components/admin/CalculoActual"; // Componente para Cálculo Actual
import CalculosAnteriores from "./components/admin/CalculosAnteriores"; // Componente para Cálculos Anteriores
              ...
              <>
                ...
                <Container sx={{ marginLeft: "240px", padding: "2rem" }}>
                  <Routes>
                    ...
                    <Route
                      path="calculo-actual"
                      element={<CalculoActual />}
                      token={token}
                    />
                    <Route
                      path="calculos-anteriores"
                      element={<CalculosAnteriores />}
                      token={token}
                    />
                  </Routes>
                </Container>
